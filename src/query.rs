...
//     pub fn to_u64_syntax_tree(&self, headers: &TableHeaders) -> U64SyntaxTree {
//         let base_index = headers.index_of(self.ident.clone()).unwrap() as u8;
//         match self.cell_type() {
//             CellType::ShortString => {
//                 let u64_vec = self.value.encode();
//                 let mut result = U64SyntaxTree::Atom(U64Atom {
//                     index: base_index,
//                     op: ComparisonOp::Equal,
//                     value: u64_vec[0],
//                 });
//                 for (v, i) in u64_vec[1..].iter().zip(1..) {
//                     result = U64SyntaxTree::And(
//                         Box::new(result),
//                         Box::new(U64SyntaxTree::Atom(U64Atom {
...
//         // an encoded cell value is either one u64 or eight u64
